...
// ==========================================
// 1. ASAL FORM COMPONENT (Isme useSearchParams use hoga)
// ==========================================
...
export default function ResetPasswordPage() {
  return (
    ...
    <Suspense fallback={<div className="min-h-[80vh] flex items-center justify-center text-lg">Loading reset form...</div>}>
      <ResetPasswordForm />
    </Suspense>
  );
}