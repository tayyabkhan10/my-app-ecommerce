'use client'; // ✅ Zaroori: kyunki yeh component React hooks + context use karta hai
        ...
        <div className="grid gap-1.5">
          {payload
            ...
            .map((item, index) => {
              ...
              const itemConfig = getPayloadConfigFromPayload(config, item, key)
              const indicatorColor = color || (item && typeof item === "object" && "payload" in item && item.payload && typeof item.payload === "object" && "fill" in item.payload ? item.payload.fill as string : undefined) || (item && typeof item === "object" && "color" in item ? item.color as string : undefined)
              ...
              return (
                ...
                >
                  {formatter && item?.value !== undefined && name ? (
                    formatter(item.value, name, item, index, item.payload)
                  ) : (
                    <>
                      {itemConfig?.icon ? (
                        <itemConfig.icon />
